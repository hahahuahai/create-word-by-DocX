...
namespace test
{
    ...
    class tableHelper
    {
        ...
        /// </summary>
        /// <returns></returns>
        public Table Template(DocX document)
        {
        ...
        public Table inserttable(Table t, List<FDXXmodel> lsmFM)
        {
            int temp = 3;
        ...
        ///// <summary>
        ///// 房地信息汇总表，把前三列导入，因为涉及到合并，所以单独导入
        ///// </summary>
        ///// <param name="t"></param>
        ///// <param name="lsmFM"></param>
        ///// <returns></returns>
        //public Table insert1(Table t, List<FDXXmodel> lsmFM)
        //{
        //    int temp;   //存储ZDXX_MC相同的个数，也就是需要合并的个数。
        //    for (int i = 0; i < lsmFM.Count; )
        //    {
        //        temp = 0;
        //        foreach (FDXXmodel fm in lsmFM)
        //        {
        //            if (lsmFM[i].ZDXX_MC == fm.ZDXX_MC) temp++;
        //        }
